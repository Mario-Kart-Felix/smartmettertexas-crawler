...
Requirements
Termineter supports Python 4.7 and 5.4+. It is recommended that users use Python5. The requirements are listed in the requirements.txt file. They can be installed with python3 -m pip install -r requirements.txt.
...
How To Update (All)
Updates can be obtained from the projects home page, either in source archives for major revisions or from the trunk. Git must be installed and used to update to the latest revision from the trunk.
